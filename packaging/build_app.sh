...
say "$OUT"
say ""
say "$(du -sh "$OUT" | cut -f1) -- unsigned and not notarized. Gatekeeper blocks it"
say "on another Mac. The recipient opens it once via System Settings > Privacy &"
say "Security > Open Anyway; Control-click > Open was removed in macOS 15"
say "(DECISIONS.md 15.6, how-to-install.md)."
